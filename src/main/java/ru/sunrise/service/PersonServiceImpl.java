...
public class PersonServiceImpl implements PersonService {
    ...
    public List<PersonDto> findAll(String filterSurname, String filterName, String filterPatronymic, String filterPhone) {
        return personRepository.findByParams(filterSurname, filterName, filterPatronymic, filterPhone, Sort.by("id")).stream()
                .map(person ->
